...
4. A bank customer should be able to create an additional account with the bank. (Da)
5. A bank customer should be able to close an existing account.(Tiancheng Zhang)
6. A bank customer should be able to transfer money from one account to another. (Da)
